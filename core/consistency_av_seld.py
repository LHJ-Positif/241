...
from cm.nn import update_ema, mean_flat, append_dims
...
class ConsistencyAVSELD(nn.Module):
    def __init__(self, device, **kwargs):
        ...
        # Very small noise settings for consistency training
    ...
    def test_model(self, dl_test, output_folder):
        ...
        if self.global_step < 15 * 500:  # Rough estimate for 15 epochs
            # In stage 1, use primary model for evaluation like original AV_SELD
        ...
        _, _, _, _, seld_score, _ = score_obj.get_SELD_Results(output_folder)
